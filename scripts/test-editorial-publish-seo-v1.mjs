...
// SEO workflows are audit/notification only. They must never be parallel main writers
// or production deploy initiators. Editorial publishing and blog-mirror publishing
// retain their own canonical write ownership.
