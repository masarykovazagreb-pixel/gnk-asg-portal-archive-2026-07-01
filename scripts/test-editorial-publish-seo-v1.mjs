...
// SEO visibility is an audit-only workflow. It must never be a parallel main writer
// or a production deploy initiator. The editorial scheduler remains the canonical
// writer/deploy owner and retains the exact-SHA dispatch contract.
