...
console.log(JSON.stringify({ok:true,forms:['hr','en'],endpoint:'/api/contact-submit',payloads:['json','multipart'],storage:'D1',mailTransport:'Cloudflare EmailMessage',mail:['internal','acknowledgement'],rateLimit:{requests:5,windowSeconds:900,store:'existing KV',failClosed:true},origin:{allowed:['https://gnk-asg.hr','https://www.gnk-asg.hr'],failClosed:true},bodyLimit:{jsonBytes:32000},storageBeforeMail:true,publicDeliveryDetailsRedacted:true,attachments:{count:3,perFileBytes:3200000,totalBytes:6400000,pdfOnly:true},studioAuth:{probe:'/api/mail-sync/health',successOnly:'2xx',failClosedOn:['401','403','404','5xx','exception']},studioDelivery:{completeStatus:200,partialStatus:207,partialOk:false,failuresExposed:true},inlineLogo:true,mailSent:false},null,2));
