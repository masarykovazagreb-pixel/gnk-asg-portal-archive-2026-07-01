...
<title>{esc(seo_title)} | AKTUAL MEDIA</title>
<meta name="description" content="{esc(description)}">
<meta name="author" content="Nermin Sefić">
<meta name="robots" content="index,follow,max-image-preview:large">
<link rel="canonical" href="{esc(canonical)}">
<link rel="alternate" hreflang="hr" href="{BASE}{hr_path}">
<link rel="alternate" hreflang="en" href="{BASE}{en_path}">
<link rel="alternate" hreflang="x-default" href="{BASE}{hr_path}">
<meta property="og:type" content="article">
<meta property="og:locale" content="{locale}">
<meta property="og:site_name" content="AKTUAL MEDIA | GNK ASG">
...
<a class="natrag" href="{back}">{back_text}</a><br>
<a class="alt-jezik" href="{alternate}">{alternate_text}</a>
<article>
  <span class="oznaka">{label}</span>
  <h1>{esc(title)}</h1>
  <img src="{esc(image_path)}" alt="{esc(title)}" style="max-width:100%;border:3px solid #241C0E;margin-bottom:20px">
{paragraphs(text)}
</article>
</body></html>'''
...
def main() -> None:
    ...
    for item in items:
        slug = item["slug"]
        targets = {
            PORTAL / "gnk-aktual" / "kolumne" / slug / "index.html": render(item, "hr"),
            PORTAL / "en" / "gnk-aktual" / "columns" / slug / "index.html": render(item, "en"),
        }
