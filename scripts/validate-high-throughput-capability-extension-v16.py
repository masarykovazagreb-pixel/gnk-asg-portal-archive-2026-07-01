...
ROOT = Path.cwd()
SRC = ROOT / 'ops' / 'high-throughput-capability-extension-v16.json'
OUT = ROOT / 'artifacts' / 'high-throughput-capability-extension-v16' / 'report.json'
failures = []

data = json.loads(SRC.read_text(encoding='utf-8'))
if data.get('version') != 'GNK_ASG_HIGH_THROUGHPUT_CAPABILITY_EXTENSION_V16': failures.append('unexpected version')
