...
p=Path('ops/high-throughput-capability-extension-v19.json')
...
out=Path('artifacts/high-throughput-capability-extension-v19');out.mkdir(parents=True,exist_ok=True)
report={'version':'GNK_ASG_HIGH_THROUGHPUT_CAPABILITY_EXTENSION_V19_VALIDATION','ok':not errors,'taskClasses':sorted(seen),'errors':errors}
