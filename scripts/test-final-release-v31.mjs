...
assert.match(editorialWrapper,/PREVIOUS_PUBLIC_EDITORIAL_VERSION='GNK_ASG_UNIFIED_AUTH_V37_NEWS_SOURCE_LINKS'/);
...
assert.match(editorialWrapper,/x-gnk-deploy-revision/);
