...
for (const key of ['singleWriter', 'exactShaCheck', 'serializedMigration', 'targetedCiRequired', 'reviewBeforeMerge']) {
...
console.log(`MASTER/NN reconciliation manifest valid for base ${data.createdFromMainSha}`);
