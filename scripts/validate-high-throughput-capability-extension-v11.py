...
ROOT = Path.cwd()
SRC = ROOT / 'ops' / 'high-throughput-capability-extension-v11.json'
OUT = ROOT / 'artifacts' / 'high-throughput-capability-extension-v11'
errors = []
...
if set(data.get('requiredRuntimeEvidence', [])) != required_evidence: errors.append('requiredRuntimeEvidence set mismatch')
seen = set()
...
report = {'version':'GNK_ASG_HIGH_THROUGHPUT_CAPABILITY_EXTENSION_V11_VALIDATION','ok':not errors,'capabilityCount':len(seen),'errors':errors}
