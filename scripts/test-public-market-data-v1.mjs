...
assert.match(VERSION,/GNK_ASG_PUBLIC_MARKET_DATA_V2_20260718_PRIMARY_ALIAS/);
...
console.log(JSON.stringify({ok:true,version:VERSION,paths:[PRIMARY_API_PATH,PUBLIC_API_PATH],sameOrigin:true,staleFallbackExplicit:true},null,2));
