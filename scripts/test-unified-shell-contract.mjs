...
assert.match(menu,/data-gnk-unified-shell|gnk-unified-header/);
...
console.log(JSON.stringify({ok:true,canonicalPortalAlias:'logo-gnk-asg-canonical.svg -> logo-gnk-asg-email.png',canonicalEmailLogo:'logo-gnk-asg-email.png',menu:'shared-public-admin',ticker:'index-only'},null,2));