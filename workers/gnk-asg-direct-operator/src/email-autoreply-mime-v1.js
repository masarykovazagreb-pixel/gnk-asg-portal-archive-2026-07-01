...
export const VERSION=`GNK_ASG_AUTOREPLY_MIME_V1_${BRAND_MIME_VERSION}`;
...
export async function buildAutoreplyRawEmail({env,fromEmail,fromName,to,subject,text,html,inReplyTo='',reference='',headers={}}={}){
 ...
 const alternative=[`--${alt}`,'Content-Type: text/plain; charset=UTF-8','Content-Transfer-Encoding: base64','',encodeBody(text),`--${alt}`,'Content-Type: text/html; charset=UTF-8','Content-Transfer-Encoding: base64','',encodeBody(html),`--${alt}--`].join('\r\n');
