...
export function patchPublicHtml(html,path){
  ...
  const visual='<link rel="stylesheet" href="/assets/public-visual-v13.css?v=20260626-align-v1">';
  ...
  const menu='<script src="/assets/public-menu-v13.js?v=20260626-align-v1" defer></script>';
...
export async function transformHtml(response,fn){
  ...
  headers.set('x-gnk-asg-public-visual','GNK_ASG_PUBLIC_VISUAL_V23_SINGLE_MENU_ALIGNED_20260626');
