...
export function patchPublicHtml(html,path){
  ...
  const visual='<link rel="stylesheet" href="/assets/public-visual-v13.css?v=20260626-stable-v29">';
  ...
  const menu='<script src="/assets/public-menu-v13.js?v=20260626-stable-v29" defer></script>';
  ...
  const indexHead='<link rel="stylesheet" href="/assets/index-group-network-v2.css?v=20260626-data-v29">';
  const indexScripts='<script src="/assets/index-group-network-en-bridge-v1.js?v=20260626-data-v29" defer></script><script src="/assets/index-group-network-v2.js?v=20260626-data-v29" defer></script><script src="/assets/index-news-rotation-v1.js?v=20260626-data-v29" defer></script><script src="/assets/index-content-resilience-v1.js?v=20260626-data-v29" defer></script><script src="/assets/index-live-market-chart-v4.js?v=20260626-data-v29" defer></script>';
...
export async function transformHtml(response,fn){
  ...
  headers.set('x-gnk-asg-public-visual','GNK_ASG_PUBLIC_VISUAL_V29_FORCE_DEPLOY_STABLE_20260626');
