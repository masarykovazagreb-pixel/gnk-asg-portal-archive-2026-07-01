...
function removeLegacyPublicShell(html){
  return html
    ...
    .replace(/<script[^>]+src=["'][^"']*\/assets\/(?:public-menu-final-v9|public-menu-v13|public-floating-home-v16|public-ai-badge-guard-v17|index-news-rotation-v1|index-content-resilience-v1|index-live-market-chart-v[1-4]|index-group-network-v2|index-group-network-en-bridge-v1)\.js[^"']*["'][^>]*><\/script>/gi,'')
...
export function patchPublicHtml(html,path){
  ...
  if(indexPath)html=html.replace(/\/assets\/index-redesign-production\.css\?v=[^"']*/gi,'/assets/index-redesign-production.css?v=20260626-stable-v30');
  const ux='<link rel="stylesheet" href="/assets/public-ux-v11.css?v=20260625-v12">';
  const visual='<link rel="stylesheet" href="/assets/public-visual-v13.css?v=20260626-stable-v30">';
  ...
  const menu='<script src="/assets/public-menu-v13.js?v=20260626-stable-v30" defer></script>';
  ...
  const indexHead='<link rel="stylesheet" href="/assets/index-group-network-v2.css?v=20260626-data-v30">';
  const indexScripts='<script src="/assets/index-group-network-en-bridge-v1.js?v=20260626-data-v30" defer></script><script src="/assets/index-group-network-v2.js?v=20260626-data-v30" defer></script><script src="/assets/index-news-rotation-v1.js?v=20260626-data-v30" defer></script><script src="/assets/index-content-resilience-v1.js?v=20260626-data-v30" defer></script><script src="/assets/index-live-market-chart-v4.js?v=20260626-data-v30" defer></script>';
...
export async function transformHtml(response,fn){
  ...
  headers.set('x-gnk-asg-public-visual','GNK_ASG_PUBLIC_VISUAL_V30_CLEAN_POLISH_20260626');
  headers.set('x-gnk-asg-index-layout-lock','STABLE_SINGLE_MENU_NO_POLISH');
  headers.set('x-gnk-asg-index-style','INDEX_STABLE_POLISH_V30');
