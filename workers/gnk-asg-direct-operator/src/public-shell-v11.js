...
function removeLegacyPublicShell(html){
  return html
    ...
    .replace(/<script[^>]+src=["'][^"']*\/assets\/(?:public-menu-final-v9|public-menu-v13|public-floating-home-v16|public-ai-badge-guard-v17|index-news-rotation-v1|index-content-resilience-v1|index-live-market-chart-v[34])\.js[^"']*["'][^>]*><\/script>/gi,'')
...
export function patchPublicHtml(html,path){
  ...
  const visual='<link rel="stylesheet" href="/assets/public-visual-v13.css?v=20260626-align-v2">';
  ...
  const menu='<script src="/assets/public-menu-v13.js?v=20260626-align-v2" defer></script>';
