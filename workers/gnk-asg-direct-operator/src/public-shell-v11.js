...
export function patchPublicHtml(html,path){
  ...
  const css='<link rel="stylesheet" href="/assets/public-ux-v11.css?v=20260625-v12"><link rel="stylesheet" href="/assets/public-menu-unified-v12.css?v=20260625-v1">';
  ...
  if(!html.includes('/assets/public-menu-unified-v12.css'))html=html.replace('</head>',`${css}</head>`);
