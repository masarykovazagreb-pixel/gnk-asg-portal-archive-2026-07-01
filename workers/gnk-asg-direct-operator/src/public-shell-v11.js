...
function removeLegacyPublicShell(html){
  return html
    ...
    .replace(/<script[^>]+src=["'][^"']*\/assets\/(?:index-news-rotation-v1|index-content-resilience-v1|index-live-market-chart-v[34])\.js[^"']*["'][^>]*><\/script>/gi,'')
...
export function patchPublicHtml(html,path){
  ...
  const visual='<link rel="stylesheet" href="/assets/public-visual-v13.css?v=20260626-stable-v3">';
  ...
  const menu='<script src="/assets/public-menu-v13.js?v=20260626-stable-v3" defer></script>';
...
export async function transformHtml(response,fn){
  ...
  headers.set('x-gnk-asg-public-visual','GNK_ASG_PUBLIC_VISUAL_V26_STABLE_SINGLE_MENU_20260626');
