...
export const VERSION='GNK_ASG_ADMIN_HUB_V28_FINAL_FUNCTIONAL_20260628';
...
async function directHtml(request,env,path){
  ...
  const headers=htmlHeaders(new Headers(response.headers));headers.set('x-gnk-asg-active-entrypoint',ENTRYPOINT);headers.set('x-gnk-asg-static-source',assetPath);
