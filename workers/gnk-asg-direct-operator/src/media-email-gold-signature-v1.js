export const VERSION='GNK_ASG_MEDIA_EMAIL_GOLD_SIGNATURE_V4_20260701_STABLE_GOLD_TWO_COLUMN';
export const MEDIA_EMAIL='media@gnk-asg.hr';
export const MEDIA_LOGO='https://gnk-asg.hr/assets/gnk-asg-email-logo-transparent.png?v=20260701-4';
