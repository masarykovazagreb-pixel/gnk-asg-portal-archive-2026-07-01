...
const RELEASE='<script defer src="/assets/release-completion-v1.js?v=20260713-index-final-v6"></script><script defer src="/assets/index-data-resilience-v1.js?v=20260713-resilience-v1"></script><script defer src="/assets/index-editorial-order-v1.js?v=20260713-editorial-v1"></script>';
...
const STATIC_HTML_ROUTES=new Map([
  ...
  ['/objave/povjerenje-investitora-kroz-transparentnost','/objave/povjerenje-investitora-kroz-transparentnost/index.html'],
  ['/objave/kiberneticka-sigurnost-i-poslovni-kontinuitet','/objave/kiberneticka-sigurnost-i-poslovni-kontinuitet/index.html'],
  ['/analize','/analize/index.html'],
  ['/analize/ai-infrastruktura-i-potrosnja-energije','/analize/ai-infrastruktura-i-potrosnja-energije/index.html'],
  ['/analize/transparentnost-podataka-kao-poslovna-infrastruktura','/analize/transparentnost-podataka-kao-poslovna-infrastruktura/index.html'],
  ['/komentari','/komentari/index.html'],
  ['/komentari/odgovornost-se-ne-moze-automatizirati','/komentari/odgovornost-se-ne-moze-automatizirati/index.html'],
  ['/komentari/novac-je-informacija-prije-nego-kapital','/komentari/novac-je-informacija-prije-nego-kapital/index.html'],
...
async function explicitHtml(request,env){
  ...
  const headers=new Headers(response.headers);headers.delete('content-length');headers.delete('content-encoding');headers.set('content-type','text/html; charset=utf-8');headers.set('cache-control','public, max-age=120, stale-while-revalidate=300');headers.set('x-gnk-explicit-html-route',targetPath);
...
async function finalize(request,response){
  ...
  try{
    ...
    headers.set('x-gnk-index-release','v6-final-resilient-editorial');
