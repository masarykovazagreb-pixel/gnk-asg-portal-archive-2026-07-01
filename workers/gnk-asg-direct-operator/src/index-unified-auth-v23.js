...
export const VERSION=`GNK_ASG_UNIFIED_AUTH_V39_CONTACT_MARKET_MAIL_HOTFIX_${CONTACT_RESILIENCE_VERSION}_${DIGITAL_WORKFORCE_SUITE_VERSION}_${MARKET_DATA_VERSION}_${EDITORIAL_ASSET_VERSION}_${BASE_VERSION}`;
