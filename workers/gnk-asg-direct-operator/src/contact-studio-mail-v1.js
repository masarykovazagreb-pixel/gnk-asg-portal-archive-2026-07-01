...
export const VERSION=`GNK_ASG_CONTACT_STUDIO_MAIL_V4_20260717_ORIGIN_BODY_STORAGE_TRUTH_AUTH_PROBE_FAIL_CLOSED_PARTIAL_DELIVERY_TRUTH_${TRANSPORT_VERSION}`;
