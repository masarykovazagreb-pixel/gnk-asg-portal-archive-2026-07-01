export const VERSION='GNK_ASG_PORTAL_EXPERIENCE_V10_20260625';
export const NEWS_MINIMUM=20;
export const NEWS_HOURS_ZAGREB=new Set([9,16]);
export const FEEDS=[
