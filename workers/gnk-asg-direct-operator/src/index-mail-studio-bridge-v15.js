...
const REVISION='4';
const MAIL_SCRIPT='<script defer src="/assets/mail-studio-auth-bridge-v15.js?v=20260626-4"></script>';
const CONTROLS_SCRIPT='<script defer src="/assets/mail-studio-controls-v18.js?v=20260626-1"></script>';
...
async function version(request,env,ctx){
  ...
  try{
    ...
    return new Response(JSON.stringify({...payload,mailStudioBridge:VERSION,mailStudioBridgeRevision:REVISION,mailStudioControls:'GNK_ASG_MAIL_STUDIO_CONTROLS_V18_20260626',adminSessionFallback:'GNK_ASG_ADMIN_SESSION_FALLBACK_V17_20260626',deployedEntryPoint:'src/index-mail-studio-bridge-v15.js'},null,2),{
      status:response.status,
      headers:{'content-type':'application/json; charset=utf-8','cache-control':'no-store','x-gnk-asg-mail-studio-bridge':VERSION,'x-gnk-asg-admin-session-fallback':'V17','x-gnk-asg-mail-studio-controls':'V18'}
    });
