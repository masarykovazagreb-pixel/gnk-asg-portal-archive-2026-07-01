export const VERSION='GNK_ASG_MEDIA_GLOBAL_AUTO_REPLY_V1_20260701';
...
export function withoutLegacyMediaAcknowledgement(env){return new Proxy(env||{}, {get(target,property,receiver){if(String(property)==='MEDIA_APPLICATION_AUTO_ACK')return'false';return Reflect.get(target,property,receiver);}});}
