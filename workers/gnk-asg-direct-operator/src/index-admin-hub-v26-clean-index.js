...
export const VERSION='GNK_ASG_PUBLIC_V12_INDEX_ISOLATED_FROM_LEGACY_20260627';
...
async function serveIsolatedIndex(path,request,env){
  ...
  headers.set('x-gnk-asg-index-isolation','LEGACY_WORKERS_BYPASSED_V12');
...
export default{
  async fetch(request,env,ctx){
    ...
    if(request.method==='GET'&&INDEX_PATHS.has(path))return serveIsolatedIndex(path,request,env);
