...
export const VERSION='GNK_ASG_ADMIN_HUB_V26_CLEAN_INDEX_20260627_R3';
...
async function diagnostic(request,env){
  ...
  const payload={ok:true,version:VERSION,entryPoint:'src/index-admin-hub-v26-clean-index.js',assets:[await check('/index-white-static-preview-v2.html'),await check('/en/index-white-static-preview-v2.html'),await check('/assets/index-white-static-v2.css'),await check('/assets/index-white-static-v2.js')]};
...
async function patch(response,path,request){
  ...
  headers.set('x-gnk-asg-index-release','20260627-live-r3');
