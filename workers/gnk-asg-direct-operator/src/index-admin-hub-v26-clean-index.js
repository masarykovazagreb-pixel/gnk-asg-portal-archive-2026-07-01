...
const V21_STYLE='<link rel="stylesheet" href="/assets/public-unified-v21.css?v=20260627-index-preview-2"><link rel="stylesheet" href="/assets/public-index-v21.css?v=20260627-index-preview-2">';
const V21_SCRIPT='<script defer src="/assets/public-shell-v21.js?v=20260627-index-preview-2"></script>';
...
function injectIndexV21(html){
  html=html.replace(/<link[^>]+(?:public-menu-v10|public-unified-v21|public-index-v21)\.css[^>]*>/gi,'').replace(/<script[^>]+(?:public-menu-v10|public-shell-v15|public-shell-v21)\.js[^>]*><\/script>/gi,'');
