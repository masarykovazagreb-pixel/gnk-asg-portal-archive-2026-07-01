...
const cityRoot=current?`${root}${city}/`:root;
internalNav.innerHTML=`<div class="restaurant-nav-inner"><a class="restaurant-home" href="${root}">GNK Royal</a><div class="restaurant-city-links"><a href="${root}hong-kong/"${city==='hong-kong'?' aria-current="page"':''}>Hong Kong</a><a href="${root}cairo/"${city==='cairo'?' aria-current="page"':''}>Cairo</a><a href="${root}singapore/"${city==='singapore'?' aria-current="page"':''}>Singapore</a></div>${current?`<div class="restaurant-section-links"><a href="${cityRoot}">Restaurant</a><a href="${cityRoot}menu.html">Food</a><a href="${cityRoot}drinks.html">Drinks</a><a href="${cityRoot}#reserve">Reserve</a></div><div class="restaurant-lang"><button type="button" data-set-lang="en">EN</button><button type="button" data-set-lang="${current.localCode}">${current.local}</button></div>`:''}</div>`;
