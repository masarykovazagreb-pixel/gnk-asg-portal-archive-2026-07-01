(() => {
  ...
  style.textContent = `
    #${WIDGET_ID} {
      position: fixed;
      right: max(142px, calc(env(safe-area-inset-right) + 128px));
    ...
    @media (max-width: 640px) {
      #${WIDGET_ID} { display: none !important;  width: 38px; height: 58px; right: max(122px, calc(env(safe-area-inset-right) + 110px)); }
