(()=>{
  ...
  style.textContent=`
    ...
    #gnk-compact-menu nav{display:none;position:absolute;right:0;top:58px;width:min(320px,calc(100vw - 24px));max-height:min(72vh,540px);overflow:auto;padding:10px;background:rgba(13,11,9,.98);border:1px solid #8f6b2f;border-radius:16px;box-shadow:0 18px 48px rgba(0,0,0,.62)}
