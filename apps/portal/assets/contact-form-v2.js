...
const text=en?{idle:'Not sent.',sending:'Sending…',stored:'Your message was recorded.',sent:'Your message was recorded and the confirmation was sent.',partial:'Your message was recorded. Email delivery is pending.',filtered:'Your submission was received.',failed:'Submission failed: ',required:'Please complete all required fields and accept the privacy notice.'}:{idle:'Nije poslano.',sending:'Slanje…',stored:'Upit je evidentiran.',sent:'Upit je evidentiran i potvrda je poslana.',partial:'Upit je evidentiran. Dostava e-pošte je u obradi.',filtered:'Vaš je zahtjev zaprimljen.',failed:'Slanje nije uspjelo: ',required:'Ispunite sva obvezna polja i prihvatite obavijest o privatnosti.'};
