(() => {
  ...
  function installLocationSlideshow() {
    if (document.getElementById('gnk-location-slideshow')) return;
    const list = document.getElementById('locationList');
    if (!list) return;

    const box = document.createElement('div');
    box.id = 'gnk-location-slideshow';
    box.setAttribute('aria-label', 'GNK ASG visual presentation');
    box.innerHTML =
      '<img class="is-active" src="/assets/brand/index-slide-1.webp" alt="GNK ASG Global Network">' +
      '<img src="/assets/brand/index-slide-2.webp" alt="GNK DINAMO Ltd. Group New York 7.10.2026">';
