(() => {
  ...
  const BPP_TITLE = 'Bitcoin Payment Processor — bpp.is';
  ...
  function markup() {
    if (isEnglish()) return '<article class="bpp-group-asset" aria-label="' + BPP_TITLE + '"><div class="bpp-top"><span class="bpp-tag">Digital infrastructure</span><span class="bpp-status">Group asset</span></div><h3>' + BPP_TITLE + '</h3><p class="bpp-owner">GNK DINAMO Ltd. group business framework</p><p class="bpp-summary">Digital asset payment infrastructure with API integration, real-time notifications and merchant dashboard capabilities. Official domain: bpp.is.</p><p class="bpp-scope"><strong>Role clarification:</strong> The software solution was developed by GNK ASG d.o.o. for the GNK DINAMO Ltd. group framework. GNK ASG d.o.o. does not operate the system, does not execute transactions through it, and Bitcoin Payment Processor is not part of its operational business.</p><a href="' + BPP_URL + '" target="_blank" rel="noopener noreferrer">Open bpp.is</a></article>';
    return '<article class="bpp-group-asset" aria-label="' + BPP_TITLE + '"><div class="bpp-top"><span class="bpp-tag">Digitalna infrastruktura</span><span class="bpp-status">Imovina grupacije</span></div><h3>' + BPP_TITLE + '</h3><p class="bpp-owner">Poslovni okvir GNK DINAMO Ltd. grupacije</p><p class="bpp-summary">Infrastruktura za plaćanje digitalnom imovinom s API integracijom, obavijestima u stvarnom vremenu i funkcionalnostima merchant dashboarda. Službena domena: bpp.is.</p><p class="bpp-scope"><strong>Razgraničenje uloge:</strong> Programsko rješenje Bitcoin Payment Processor izradio je GNK ASG d.o.o. za poslovni okvir GNK DINAMO Ltd. grupacije. GNK ASG d.o.o. ne upravlja sustavom, ne provodi transakcije putem sustava i Bitcoin Payment Processor nije dio njegova operativnog poslovanja.</p><a href="' + BPP_URL + '" target="_blank" rel="noopener noreferrer">Otvori bpp.is</a></article>';
  }
