...
This is deliberately narrow: the global runtime may always emit Organization/WebSite,
but Person/GNK DINAMO/author signals must be activated only from page-local evidence.
"""
...
if failed:
    raise SystemExit('sitewide entity truth regression: ' + ', '.join(failed))
